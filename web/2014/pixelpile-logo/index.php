...
<?php include($_SERVER['DOCUMENT_ROOT'].'/branding-block.inc'); ?>
    ...
    <div class="experimental-page">
        ...
        <div class="pixelpile-color-2" style="padding:20px 0;width:49%;display:inline-block;">
        ...
        <div class="pixelpile-color-2 pixelpile-dark" style="padding:20px 0;width:49%;display:inline-block;">
            <div class="pixelpile-lockup pixelpile-lockup-horizontal" style="font-size:0.25em;">
                <div class="pixelpile-logo"><img src="pixelpile-logo-dark.png" alt="" /></div>
                <div class="pixelpile-logotype">
                    <div class="pixelpile-logotype-primary">Pixel{<span class="pixelpile-logotype-pile">pile</span>}</div>
        ...
        <div class="pixelpile-color-3" style="padding:20px 0;width:49%;display:inline-block;">
            <div class="pixelpile-lockup pixelpile-lockup-horizontal" style="font-size:0.25em;">
                <div class="pixelpile-logo"><img src="pixelpile-logo.png" alt="" /></div>
                <div class="pixelpile-logotype">
                    <div class="pixelpile-logotype-primary">Pixel{<span class="pixelpile-logotype-pile">pile</span>}</div>
        ...
        <div class="pixelpile-color-3 pixelpile-dark" style="padding:20px 0;width:49%;display:inline-block;">
            <div class="pixelpile-lockup pixelpile-lockup-horizontal" style="font-size:0.25em;">
                <div class="pixelpile-logo"><img src="pixelpile-logo-dark.png" alt="" /></div>
                <div class="pixelpile-logotype">
                    <div class="pixelpile-logotype-primary">Pixel{<span class="pixelpile-logotype-pile">pile</span>}</div>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'].'/branding-non-free.inc'); ?>
    </div>
