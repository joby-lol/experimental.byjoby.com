...
//get image path info
	...
	$IMPLACE_JOB['OUTPUT_FORMAT'] = strtolower($pathinfo['extension']);
...
//decide where generated image should be
	...
	$IMPLACE_JOB['IMAGE_GENERATED_URL'][] = $IMPLACE_JOB['IMAGE_DIR_URL'];
	//original filename
	...
	$IMPLACE_JOB['IMAGE_GENERATED_URL'] .= '.'.$IMPLACE_JOB['OUTPUT_FORMAT'];
...
if (!$IMPLACE_JOB['LOADED_FROM_CACHE']) {
	...
	//save the result
		...
		//output from gd
		switch ($IMPLACE_JOB['OUTPUT_FORMAT']) {
			case 'gif':
